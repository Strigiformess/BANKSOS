...
class _BookmarksScreenState extends State<BookmarksScreen> {
  ...
  Future<void> _removeBookmark(_BookmarkEntry entry) async {
    ...
    await SyncService.instance.toggleBookmark(
      userId: _cleanId(rawUserId),
      questionId: _cleanId(entry.question.id),
    );
      ...
      body: ValueListenableBuilder<Box<BookmarkModel>>(
        ...
        builder: (context, box, _) {
          ...
          for (final bm in bookmarks) {
            ...
            try {
              question = questionBox.get(targetQId);
            } catch (_) {}
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (context, i) => _BookmarkCard(
                    ...
                    onTap: () => Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (_) =>
                            QuestionDetailScreen(question: entries[i].question),
                      ),
                    ),
                  ),
                ),
      ...
      confirmDismiss: (_) async {
        return await showDialog<bool>(
              ...
              builder: (ctx) => AlertDialog(
                ...
                content:
                    const Text('Soal ini akan dihapus dari daftar tersimpan.'),
                actions: [
                  TextButton(
              ...
              children: [
                Row(
                  children: [
                    ...
                    const Spacer(),
                    Text(_formatDate(entry.bookmark.createdAt),
                ...
                Text(_buildPlaceholder(question.jawaban),
                ...
                Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(question.kategoriNama,
                          style: AppTextStyles.caption,
                          overflow: TextOverflow.ellipsis),
                    ),
                    if (question.hints.isNotEmpty) ...[
                      ...
                      Text('${question.hints.length} hint',
                          style: AppTextStyles.caption),
                    ],
                  ],
                ),
