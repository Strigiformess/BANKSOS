...
// Sprint 6 UPDATE — Revaldi (RP): Integrasi AppAdaptiveColors ke lightTheme & darkTheme
//
// PERUBAHAN SPRINT 6:
//   - lightTheme: extensions: [AppAdaptiveColors.light]
//   - darkTheme:  extensions: [AppAdaptiveColors.dark]
//   - darkTheme dilengkapi: InputDecorationTheme, CardTheme, ChipTheme,
//     ElevatedButton, OutlinedButton, SnackBar, Divider, ListTile
//
// Aturan untuk seluruh tim:
//   - WARNA STATIK (tidak berubah mode) → tetap pakai AppColors.*
//     Contoh: AppColors.primaryBlue, AppColors.errorRed
//   - WARNA ADAPTIF (berbeda light/dark) → pakai context.colors.*
//     Contoh: context.colors.cardBg, context.colors.primaryText
...
// ══════════════════════════════════════════════════════════════════════════════
// DEKORASI STATIK (tidak bergantung mode)
// ══════════════════════════════════════════════════════════════════════════════
class AppDecorations {
  ...
  static const BoxDecoration inputError = BoxDecoration(
    color: AppColors.bgWhite,
    borderRadius: AppRadius.mdAll,
    border: Border.fromBorderSide(BorderSide(color: AppColors.errorRed)),
  );
...
// ══════════════════════════════════════════════════════════════════════════════
// THEME DATA — Sprint 6: darkTheme dilengkapi + extensions didaftarkan
// ══════════════════════════════════════════════════════════════════════════════
class AppTheme {
  AppTheme._();
  ...
  static ThemeData get lightTheme {
    return ThemeData(
      ...
      // ── Sprint 6: AppAdaptiveColors terdaftar ──────────────────────────
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        border:             OutlineInputBorder(borderRadius: AppRadius.mdAll, borderSide: const BorderSide(color: AppColors.borderGrey)),
        enabledBorder:      OutlineInputBorder(borderRadius: AppRadius.mdAll, borderSide: const BorderSide(color: AppColors.borderGrey)),
        focusedBorder:      OutlineInputBorder(borderRadius: AppRadius.mdAll, borderSide: const BorderSide(color: AppColors.primaryBlue, width: 2)),
        errorBorder:        OutlineInputBorder(borderRadius: AppRadius.mdAll, borderSide: const BorderSide(color: AppColors.errorRed)),
        focusedErrorBorder: OutlineInputBorder(borderRadius: AppRadius.mdAll, borderSide: const BorderSide(color: AppColors.errorRed, width: 2)),
      ...
      dividerTheme: const DividerThemeData(color: AppColors.borderGrey, thickness: 0.5, space: 0),
  ...
  // ─── Dark Theme ───────────────────────────────────────────────────────────
  // Sprint 6: dark theme dilengkapi agar semua komponen konsisten.
  static ThemeData get darkTheme {
    ...
    return ThemeData(
      ...
      // ── Sprint 6: AppAdaptiveColors dark terdaftar ────────────────────
      extensions: const <ThemeExtension<dynamic>>[
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        fillColor: darkInput,
        contentPadding: const EdgeInsets.symmetric(horizontal: 16, vertical: 14),
        border:             OutlineInputBorder(borderRadius: AppRadius.mdAll, borderSide: const BorderSide(color: darkBorder)),
        enabledBorder:      OutlineInputBorder(borderRadius: AppRadius.mdAll, borderSide: const BorderSide(color: darkBorder)),
        focusedBorder:      OutlineInputBorder(borderRadius: AppRadius.mdAll, borderSide: const BorderSide(color: darkPrimary, width: 2)),
        errorBorder:        OutlineInputBorder(borderRadius: AppRadius.mdAll, borderSide: const BorderSide(color: AppColors.errorRed)),
        focusedErrorBorder: OutlineInputBorder(borderRadius: AppRadius.mdAll, borderSide: const BorderSide(color: AppColors.errorRed, width: 2)),
        errorStyle: AppTextStyles.bodyError,
      ...
      textTheme: TextTheme(
        ...
        bodyMedium:  AppTextStyles.body.copyWith(color: darkText),
        bodySmall:   AppTextStyles.small.copyWith(color: darkSubtext),
        titleLarge:  AppTextStyles.h1.copyWith(color: darkText),
        titleMedium: AppTextStyles.h2.copyWith(color: darkText),
        titleSmall:  AppTextStyles.h3.copyWith(color: darkText),
        labelSmall:  AppTextStyles.caption.copyWith(color: darkSubtext),
      ),
