...
class AppAdaptiveColors extends ThemeExtension<AppAdaptiveColors> {
  const AppAdaptiveColors({
    ...
    required this.badgeEasyBg,
    required this.badgeEasyText,
    required this.badgeMediumBg,
    required this.badgeMediumText,
    required this.badgeHardBg,
    required this.badgeHardText,
  ...
  final Color badgeEasyBg;
  final Color badgeEasyText;
  final Color badgeMediumBg;
  final Color badgeMediumText;
  final Color badgeHardBg;
  final Color badgeHardText;
  ...
  static const light = AppAdaptiveColors(
    ...
    badgeEasyBg: AppColors.easyBg,
    badgeEasyText: AppColors.easyText,
    badgeMediumBg: AppColors.mediumBg,
    badgeMediumText: AppColors.mediumText,
    badgeHardBg: AppColors.hardBg,
    badgeHardText: AppColors.hardText,
  ...
  static const dark = AppAdaptiveColors(
    ...
    questionCardBg: Color(0x1A4A90D9),
  ...
  AppAdaptiveColors copyWith({
    ...
    return AppAdaptiveColors(
      ...
      badgeEasyBg: badgeEasyBg ?? this.badgeEasyBg,
      badgeEasyText: badgeEasyText ?? this.badgeEasyText,
      badgeMediumBg: badgeMediumBg ?? this.badgeMediumBg,
      badgeMediumText: badgeMediumText ?? this.badgeMediumText,
      badgeHardBg: badgeHardBg ?? this.badgeHardBg,
      badgeHardText: badgeHardText ?? this.badgeHardText,
  ...
  AppAdaptiveColors lerp(AppAdaptiveColors? other, double t) {
    ...
    return AppAdaptiveColors(
      ...
      badgeEasyBg: Color.lerp(badgeEasyBg, other.badgeEasyBg, t)!,
      badgeEasyText: Color.lerp(badgeEasyText, other.badgeEasyText, t)!,
      badgeMediumBg: Color.lerp(badgeMediumBg, other.badgeMediumBg, t)!,
      badgeMediumText: Color.lerp(badgeMediumText, other.badgeMediumText, t)!,
      badgeHardBg: Color.lerp(badgeHardBg, other.badgeHardBg, t)!,
      badgeHardText: Color.lerp(badgeHardText, other.badgeHardText, t)!,
